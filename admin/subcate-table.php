    ...
    <tbody>
        ...
        ?>
                <tr>
                    ...
                    <td><button type="button" id="editcat<?php echo $subcat_id ?>" class="btn btn-primary" value="<?php echo $subcat_id ?>"><i class="fa fa-pencil"></i></button></td>
                    <script>
                        $(document).ready(function() {
                            $('#editcat<?php echo $subcat_id ?>').click(function() {
                                var edit = $(this).val();
                                $.ajax({
                                    method: 'GET',
                                    url: 'subcate-edit.php',
                                    data: {
                                        edit: edit
                                    },
                    ...
                    <td><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal<?php echo $subcat_id ?>"><i class="fa fa-close"></i></button></td>
                </tr>

                <!-- del categories -->
                <div class="modal fade" id="exampleModal<?php echo $subcat_id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="modal-title" id="exampleModalLabel<?php echo $subcat_id ?>" style="margin: auto;text-align: center;">
                            ...
                            <div class="modal-body" style="margin: auto;">
                                <h6 style="font-family: Roboto,Helvetica,Arial,sans-serif; font-size:16px;">Bạn có chắc muốn xóa <?php echo $subcat_name ?> không?</h6>
                            </div>
