...
<body class="h-100">
    ...
    <div class="login-form-bg h-100" style="padding-top: 100px;">
                        ...
                        <div class="card mb-0">
                            <div class="card-body text-center pt-5">
                                ...
                                <form class="mt-5 mb-5">
                                    ...
                                    <div class="text-center mb-4 mt-4"><a href="dashboard.php" class="btn btn-primary">Go back to Dashboard</a>
                                    </div>
                                </form>
